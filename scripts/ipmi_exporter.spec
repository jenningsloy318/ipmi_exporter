...
License: MIT
URL:     https://github.com/jenningsloy318/ipmi_exporter
...
This is an exporter that exposes information gathered from IPMI database for use by the Prometheus monitoring system.
...
systemctl enable ipmi_exporter || true
...
%config(noreplace) %{_sysconfdir}/prometheus/ipmi_exporter.yml
